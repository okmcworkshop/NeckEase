...
![neGuard圖片](images/neGuard_v3.jpg)
...
第1步) 先檢查電線有否破損、斷裂或其他可能導致短路的情況

![組裝說明 - 1](images/step_0.JPG)

將 neGuard 開關掣撥到接通，進行測試 > 開啟"NeckEase 頸智鬆" 應用程式 > "姿態提示" 頁面 > 點擊螢幕有上方藍牙 icon
如果顯示 "已找到 neGuard" > 關閉 neGuard 電源繼續組裝程序

![組裝說明 - 1](images/step_1.JPG)


第2步) 將充電模組放入3D打印外殼

![組裝說明 - 2](images/step_2.JPG)


第3步) MPU6050 及 ESP32C3 背面加上雙面膠

![組裝說明 - 3](images/step_3.JPG)

第4步) 放入 MPU6050 及 ESP32-C3，稍加壓力固定 

![組裝說明 - 4](images/step_4.JPG)


第5步) 放入 5549 光敏電阻

![組裝說明 - 5](images/step_5.JPG)


第6步) 將震動馬達及模組主板分離(不處理有機會放不進外殼)

![組裝說明 - 6](images/step_6.JPG)


第7步) 如圖片顯示把震動馬達放好並固定(留意電線位置)

![組裝說明 - 7](images/step_7.JPG)


第8步) 放入 震動馬達模組，並用螺絲固定好

![組裝說明 - 8](images/step_8.JPG)


第9步) 電池放在外殼頂蓋

![組裝說明 - 9](images/step_9.JPG)


第10步) 蓋好頂蓋，並用螺絲固定好

![組裝說明 - 10](images/step_10.JPG)


第11步) 加上掛耳

![組裝說明 - 11](images/step_11.JPG)
